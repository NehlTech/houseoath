...
export default function Sidebar({ onSelectClient, onNewClient, onOpenSettings, onOpenProfile, onOpenWalkInBilling, onToggleSidebar }: SidebarProps) {
 ...
 <span className={`text-[9px] font-bold tracking-wider px-2 py-0.5 rounded-full shrink-0 ${
 ...
 <span className="text-[10px] font-bold tracking-wider">Archive</span>
 </button>
 ...
 <span className="text-[10px] font-bold tracking-wider">Clients</span>
 </button>
 ...
 <span className="text-[10px] font-bold tracking-wider">Log out</span>
 </button>
 </div>
 </div>
 );
