...
export default function EmptyState() {
 ...
 <span className="text-[11px] font-bold tracking-wider text-charcoal">Active Projects</span>
 </div>
 <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-primary/5 shadow-sm border-none">
 <span className="material-symbols-outlined text-primary text-[16px]">schedule</span>
 <span className="text-[11px] font-bold tracking-wider text-charcoal">Fittings Today</span>
 </div>
 </div>
 </div>
 </div>
