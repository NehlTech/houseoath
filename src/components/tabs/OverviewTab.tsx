...
export default function OverviewTab({ client }: OverviewTabProps) {
 ...
 <p className="text-gray text-[11px] font-bold tracking-wider">Days to Event</p>
 </div>
 ...
 <p className="text-gray text-[11px] font-bold tracking-wider">Total Payments</p>
 </div>
 ...
 <p className="text-gray text-[11px] font-bold tracking-wider">Work Progress</p>
 </div>
 ...
 <span className="text-[11px] text-primary/60 font-medium tracking-wider">Edit</span>
 </div>
