...
export default function FabricTab({ client }: FabricTabProps) {
 ...
 <div>
 <label className="block text-xs font-bold tracking-wider text-gray mb-1.5">Fabric Name</label>
 <input
 className={inputCls}
 ...
 <div>
 <label className="block text-xs font-bold tracking-wider text-gray mb-1.5">Vendor Name</label>
 <input
 className={inputCls}
 ...
 <div>
 <label className="block text-xs font-bold tracking-wider text-gray mb-1.5">Fabric Type</label>
 <select
 className={inputCls}
 value={form.type}
 ...
 <div className="space-y-4">
 <div>
 <label className="block text-xs font-bold tracking-wider text-gray mb-1.5">Notes & Description</label>
 <textarea
 ...
 <div>
 <label className="block text-xs font-bold tracking-wider text-gray mb-1.5">Fabric Photo</label>
 <div
...
function FabricCard({ fabric, onPreview, onSetReceived }: FabricCardProps) {
 ...
 />
 <div className="absolute top-3 right-3 bg-primary text-white text-[10px] font-bold px-2.5 py-1 rounded-full tracking-wider shadow-md">
 {fabric.type}
 </div>
 {/* Fullscreen hint */}
