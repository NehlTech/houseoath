          ...
          {fittingDate ? (
            <>
              <div className="flex items-start justify-between gap-3 flex-wrap">
                <div>
                  <p className="text-xs font-bold uppercase tracking-wider text-gray mb-1.5">Scheduled Fitting Date</p>
              ...
              {showReschedule && (
                <div className="border border-primary/20 rounded-xl p-4 bg-primary/5 space-y-3 animate-fade-in">
                  ...
                  <div>
                    <label className="block text-xs font-bold uppercase tracking-wider text-gray mb-1.5">New Date</label>
                    <input
                      type="date"
                      className={inputCls}
                  ...
                  <div>
                    <label className="block text-xs font-bold uppercase tracking-wider text-gray mb-1.5">Reason (optional)</label>
                    <textarea
