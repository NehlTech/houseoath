...
export default function IllustrationTab({ client, setActiveTab: _setActiveTab }: IllustrationTabProps) {
 ...
 <div className="flex items-center gap-3">
 <div>
 <p className="text-xs font-bold text-primary tracking-normal">House of Oath Design Studio</p>
 ...
 <h4 className="text-xs font-bold text-slate-500 tracking-wider hidden lg:block mb-2">Design Iterations</h4>
