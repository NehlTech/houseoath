...
export default function ClientWorkspace({ client, onBack }: ClientWorkspaceProps) {
 ...
 <div className="absolute right-3 md:right-8 lg:right-14 md:top-5 z-10 ios-badge-top flex flex-col items-start gap-0">
 <div
 className="size-16 md:size-24 lg:size-32 drop-shadow-lg md:-translate-y-3 lg:-translate-y-4"
 style={{
 backgroundColor: '#d4af35',
 WebkitMaskImage: 'url(/ho_logo.png)',
 maskImage: 'url(/ho_logo.png)',
 ...
 className={`flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold tracking-wider transition-all ${
 ...
 className="flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold tracking-wider text-white transition-colors"
 ...
 <span className="flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold tracking-wider text-white/55" style={{ background: 'rgba(255,255,255,0.10)' }}>
 ...
 className="flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold tracking-wider text-primary transition-colors animate-pulse"
