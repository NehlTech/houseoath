      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-5 pb-6 space-y-6">
          ...
          <div className="space-y-4">
            <p className="text-[10px] font-bold uppercase tracking-widest text-muted">Personal Info</p>
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-gray mb-2">Display Name</label>
              <input
                type="text"
                value={name}
            ...
            <div>
              ...
              />
              <p className="text-[10px] uppercase tracking-wider font-bold text-muted mt-2">Contact support to change your email.</p>
            </div>
