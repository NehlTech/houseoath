...
export default function ForgotPasswordPage() {
 ...
 <h2 className="text-charcoal text-xl font-display font-bold leading-tight tracking-normal ml-1">House of Oath Fashion</h2>
 </div>
 </header>
 ...
 className="w-full border border-border text-gray font-bold tracking-normal text-sm h-12 rounded-xl transition-all hover:bg-canvas"
 >
 Try a different email
 </button>
 <Link
 href="/login"
 className="w-full flex items-center justify-center gap-2 bg-primary text-white font-bold tracking-normal text-sm h-12 rounded-xl transition-all hover:bg-[#E5C04A]"
 >
 ...
 type="submit"
 disabled={loading}
 className="w-full bg-primary text-white font-bold tracking-normal text-sm h-14 rounded-xl transition-all shadow-md hover:shadow-lg hover:bg-[#E5C04A] flex items-center justify-center gap-2 mt-4 disabled:opacity-60"
 >
 ...
 <p className="text-[10px] tracking-normal font-bold text-muted">© 2026 House of Oath Fashion. All rights reserved.</p>
 </footer>
 </div>
 </div>
 );
